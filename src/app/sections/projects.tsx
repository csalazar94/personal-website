      ...
      <div className="grid grid-cols-1 sm:grid-cols-5 gap-2 items-start mt-6">
        <div className="relative col-span-1 sm:col-span-2 border-2 border-[#82AAFF]">
          <Dialog>
            ...
            <DialogContent className="px-2 sm:px-6 sm:max-w-4xl">
              <DialogHeader>
                <DialogTitle>ArriendosPro</DialogTitle>
              </DialogHeader>
              <Carousel className="mb-6">
                <CarouselContent>
                  <CarouselItem>
                    <img
                      className="h-full w-full object-contain"
                      src="/projects/arriendospro/screenshots/dashboard.png"
                    />
                  </CarouselItem>
                  <CarouselItem>
                    <img
                      className="h-full w-full object-contain"
                      src="/projects/arriendospro/screenshots/rentals.png"
                    />
                  </CarouselItem>
                  <CarouselItem>
                    <img
                      className="h-full w-full object-contain"
                      src="/projects/arriendospro/screenshots/create-customer.png"
                    />
                  </CarouselItem>
                </CarouselContent>
                <CarouselPrevious variant="secondary" />
        ...
        <div className="col-span-1 sm:col-span-3">
          <H4 className="uppercase font-medium">ArriendosPro</H4>
          <P>
            A platform for managing product rentals with automated bookings and
            inventory tracking.
          </P>
          <div className="flex gap-2 flex-wrap mt-2">
            <Tag>Go</Tag>
